...
$reports->addReportClass(_('Archivos Nestle'));
$reports->addReport(_('Archivos Nestle'),119,_('Listado de &Productos'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Archivos Nestle'),114,_('Listado de &Tiendas'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Archivos Nestle'),117,_('&Reporte de Ventas diarias'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Archivos Nestle'),118,_('&Movimientos de inventario diarios'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
